...
export const IpfsInfoModal = () => {
	...
	return (
		<Modal
			className={
				"p-5 rounded-lg lg:ml-[288px]" +
				(theme === Theme.DARK ? " dark-theme4" : " bg-white")
			}
		>
			<div
				className={
					"rounded-lg relative modal-center " +
					(theme === Theme.DARK ? " dark-theme4" : " bg-white")
				}
			>
				<p>
					{/* When you enter <b>hello.app</b>, you automatically connect as an IPFS node on your browser. */}
					{language[lang]["1151"]} <b>hello.app</b>,{" "}
					{language[lang]["1152"]}
					<br />
					<span className="text-orange-700 my-2">
				...
				<div className="w-full flex items-center justify-center p-2 my-2">
					<button
						className={
							"text-blue-700 border border-gray-300 bg-transparent focus:outline-none rounded-full text-sm text-center" +
							(theme === Theme.DARK
								? " dark-theme3"
								: " hover:bg-gray-200")
						}
					>
						<a
							...
							href="https://docs.hello.app/ipfs/ipfs-gateway"
							target="_blank"
						>
				...
				<div className="flex items-end justify-end">
					<button
						className={
							"text-blue-700 border border-gray-300 bg-transparent focus:outline-none rounded-full text-sm px-5 py-2.5 text-center" +
							(theme === Theme.DARK
								? " dark-theme3"
								: " hover:bg-gray-200")
						}
