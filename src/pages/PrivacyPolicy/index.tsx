export default function PrivacyPolicy() {
    return (
        <div style={{
            backgroundColor: "#abf3aa",
            textAlign: "justify",
        }}>
            <div
                className="overflow-auto custom-scrollbar max-h-screen ml-4 mr-4444-gray-100 flex items-center flex-col">
                <h1 className="mb-2"><u>Privacy Policy for hello.app</u></h1>
                <div className="text-left">
                    <p>Last updated: 04/02/2024</p>
                    <p>Welcome to hello.app ("we", "us", or "our"). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice or our practices with regard to your personal information, please contact us at <a className="text-blue-500" href="mailto:team@hello.app">team@hello.app</a></p>

                    <p>Visit our website at <a className="text-blue-500" href="https://hello.app/">https://hello.app</a></p>
                    <p className="mt-2 mb-2"><b>This privacy notice describes how we might use your information if you:</b></p>
                    ...
                    <ul>
                        <li>
                            <b>"Website"</b>, we are referring to any website of ours that references or links to this policy
                        </li>
                        <li>
                            <b>"Services"</b>, we are referring to our Website, and other related services, including any sales, marketing, or events
                        </li>
                    </ul>
                    <p className="mt-2 mb-2">Please read this privacy policy carefully, as it will help you understand what we do with the information that we collect.</p>
                    ...
                    <p className="mt-2"><b>The personal information that we collect depends on the context of your interactions with us and the Website, the choices you make, and the products and features you use. The personal information we collect may include the following:</b></p>

                    <p>·Publicly available personal information.</p>
                    <p>·Personal Information Provided by You. We collect names; email addresses; usernames; contact preferences; contact or authentication data; and other similar information.</p>
                    <p>·Social Media Login Data. We may provide you with the option to register with us using your existing Google account details, for a quicker and easier sign-up process. If you choose to register in this way, we will collect the information described in the section called "HOW DO WE HANDLE YOUR SOCIAL LOGINS" below.</p>
                    <p>·Information automatically collected</p>
                    <p>·In some cases, we automatically collect certain information when you visit our Website or use our Services.</p>
                    <p>·Information collected through our App</p>
                    <p>·We collect information regarding your mobile device, push notifications, when you use our app.</p>
                    ...
                    <h3 className="mb-2 mt-2"><b>2. HOW DO WE USE YOUR INFORMATION?</b></h3>
                    ...
                    <p className="mt-2"><b>We use the information we collect or receive:</b></p>

                    <p>To facilitate account creation and logon process. If you choose to link your account with us to a third-party account (such as your Google account), we use the information you allowed us to collect from those third parties to facilitate account creation and logon process for the performance of the contract.</p>
                    ...
                    <p>Fulfill and manage your orders. We may use your information to fulfill and manage your orders, payments, returns, and exchanges made through the Website or App.</p>
                    <p>To post testimonials. We post testimonials on our Website that may contain personal information. Before posting a testimonial, we will obtain your consent to use your name and the content of the testimonial. If you wish to update or delete your testimonial, please contact us at team@hello.app and be sure to include your name, testimonial location, and contact information.</p>
                    ...
                    <p>For other business purposes. We may use your information for other business purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns, and to evaluate and improve our Website, products, marketing, and your experience.</p>
                    <h3 className="mt-2 mb-2"><b>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</b></h3>
                    ...
                    <p><b>Google OAuth</b>: <b>hello.app</b> uses Google OAuth for authentication and access to Google user data. We adhere to Google’s Limited Use requirements and ensure your Google data is handled securely and in accordance with our privacy policy and Google’s guidelines.</p>
                    <h3 className="mt-2 mb-2"><b>4. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</b></h3>
                    ...
                    <h3 className="mt-2 mb-2"><b>5. HOW LONG DO WE KEEP YOUR INFORMATION?</b></h3>
                    ...
                    <h3 className="mb-2 mt-2"><b>7. WHAT ARE YOUR PRIVACY RIGHTS?</b></h3>
                    <p>You have rights that allow you greater access to and control over your personal information. You may review, change, or terminate your account at any time.</p>
                    ...
                    <p>If you are a resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: [Link to data protection authorities].</p>

                    <p>If you have questions or comments about your privacy rights, you may email us at team@hello.app</p>

                    <h3 className="mb-2 mt-2"><b>8. CONTROLS FOR DO-NOT-TRACK FEATURES</b></h3>
                    ...
                    <h3 className="mt-2 mb-2"><b>9. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</b></h3>
                    ...
                    <h3 className="mb-2 mt-2"><b>10. DO WE MAKE UPDATES TO THIS POLICY?</b></h3>
                    ...
                    <h3 className="mb-2 mt-2"><b>11. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</b></h3>
                    <p>If you have questions or comments about this policy, you may email us at team@hello.app or by post to:</p>
