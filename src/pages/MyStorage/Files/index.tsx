...
import { HiDocumentDuplicate, HiDotsVertical, HiDocumentText, HiFolder } from "react-icons/hi";
            ...
            {files.map((v, i) => (
                ...
                >
                    ...
                    <td className="py-1 px-3 text-right">
                        <button className="rounded-full hover:bg-gray-300 p-3" onClick={(e) => handleDropdownClick('file', i, e)}>
                            <HiDotsVertical />
