...
import { decryptFilename, handleEncryptedFiles } from "utils/encryption/filesCipher";
...
export const folderDownload = async (personalSignature: string, folder: Folder, 
    dispatch: AppDispatch, logout: () => void, 
    name: string, autoEncryptionEnabled: boolean, accountType: string) => {
