  ...
  return (
    <SearchContext.Provider value={{ searchTerm, setSearchTerm }}>
      <div style={{fontFamily: "SF Mono", height: "100%"}} className="flex flex-col justify-between">
        {!sidebarOpen && (
          <div className="sticky flex items-center justify-between w-full px-5 py-2 bg-gray-100 lg:hidden">
        ...
        <div className="flex flex-grow lg:h-screen" style={{
          ...
          <div
            ...
            className={`flex flex-col flex-1 md:px-10 px-5 py-4 overflow-y-auto h-full ${
